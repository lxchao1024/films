package com.bhcj.edu.films.config;

import com.bhcj.edu.films.filter.URLPathMatchingFilter;
import com.bhcj.edu.films.realm.CustomRealm;
...
public class ShiroConfig {
    ...
    @Bean
    public CustomRealm getWJRealm() {
        CustomRealm wjRealm = new CustomRealm();
